 ...
 * 
 */
@WebServiceClient(name = "WeatherWebService", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/F:/temp/chinaWeather.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/F:/temp/chinaWeather.xml");
