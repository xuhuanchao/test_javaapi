 ...
 * 
 */
@WebServiceClient(name = "EchoService", targetNamespace = "http://ws.xml.javax.test.xhc.com/", wsdlLocation = "http://localhost:8081/echo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ECHOSERVICE_QNAME = new QName("http://ws.xml.javax.test.xhc.com/", "EchoService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/echo?wsdl");
    ...
    public Echo getEchoPort() {
        return super.getPort(new QName("http://ws.xml.javax.test.xhc.com/", "EchoPort"), Echo.class);
    }
    ...
    public Echo getEchoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.xml.javax.test.xhc.com/", "EchoPort"), Echo.class, features);
    }
